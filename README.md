...
## 1. 잘된 점
- **효과적인 의사소통**: 팀원 간의 활발하고 효율적인 의사소통 덕분에 새로운 분야에 도전하면서도 만족스러운 결과를 얻을 수 있었다.
- **Linux 및 ROS 활용 능력 향상**: 프로젝트를 통해 Linux와 ROS에 대한 실무 경험을 쌓으며 기술적 역량을 크게 발전시킬 수 있었다.
## 2. 개선할 점
- **Slam 오차 보정 필요**: Slam 구현 시 실제 거리와의 오차가 발생했으며, 이를 해결하기 위해 보다 정밀한 매핑 기술이 필요했다.
- **백업 습관 부족**: 예민한 보드 사용 환경에서 정기적인 백업 습관이 부족했던 점을 보완해야 한다.
## 3. 교훈
- **이론과 실험의 균형**: 이론에만 의존하지 않고 실제 환경에서 실험과 검증을 병행하는 것이 성공적인 프로젝트의 핵심이다.
- **철저한 프로젝트 관리**: 회의와 개발 과정에서 지속적으로 기록을 남기고, 데이터를 정기적으로 백업하는 습관이 프로젝트 안정성을 높인다.
